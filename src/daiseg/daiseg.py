...
def main():
    parser = argparse.ArgumentParser(
        description=print_script_usage(), formatter_class=argparse.RawTextHelpFormatter
    )
    ...
    decode_subparser = subparser.add_parser(
        "run.with.EM", help="Run Global EM training and Inference"
    )
    decode_subparser.add_argument(
        "-threads", help="Number of threads (optional)", type=int
    )
    decode_subparser.add_argument(
